    ...
    <div className="bg-black overflow-hidden" >
         <div className="flex flex-col justify-center items-center mt-36 gap-5">
            ...
            <form action="" className="flex flex-col gap-5 w-[80%] sm:w-[60%] lg:w-[50%]">
                <input type="text" className="bg-slate-800 text-slate-900 w-[100%] py-2 rounded px-3" placeholder="Your email address" />
                <textarea name="" className="bg-slate-800 text-slate-900 w-[100%] py-2 px-3 rounded" id="" placeholder="Your message"></textarea>
